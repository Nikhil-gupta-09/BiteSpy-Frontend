...
export default function OurMotivation() {
  return (
    <section
      className="py-24 px-6 md:px-12 w-full text-white relative flex justify-center items-center overflow-hidden"
      style={{ background: "#0b1d35" }}
    >
      {/* Background decorations */}
      <div className="absolute w-[500px] h-[500px] bg-blue-600/10 blur-[150px] rounded-full top-[-100px] left-[-200px] pointer-events-none" />
      <div className="absolute w-[400px] h-[400px] bg-sky-500/8 blur-[120px] rounded-full bottom-[-100px] right-[-100px] pointer-events-none" />
      ...
      <div className="max-w-[1300px] w-full relative z-10 grid lg:grid-cols-[1.1fr_0.9fr] gap-16 lg:gap-24 items-center">
        ...
        >
          <h2 className="text-5xl lg:text-6xl font-semibold leading-tight mb-8">
            ...
            <span
              className="
                ...
                drop-shadow-[0_0_16px_rgba(96,165,250,0.35)]
              "
            >
              Motivation
            </span>
          ...
          <div className="space-y-6 text-lg md:text-xl text-blue-100/80 leading-relaxed font-medium">
            <p>
            ...
            <div
              className="p-6 md:p-8 mt-10 rounded-3xl backdrop-blur-md shadow-2xl relative border"
              style={{
            ...
            >
              <p className="text-white text-xl leading-relaxed font-medium mb-6">
                &ldquo;Because of false claims and misinformation, it is the public that suffers. Our aim is to build a community platform that helps people get closer to the truth.&rdquo;
              </p>
              <div className="flex items-center gap-3 text-sky-300 font-bold uppercase tracking-widest text-sm">
        ...
        >
          {/* Glow behind card */}
          <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/15 to-sky-500/15 rounded-3xl blur-[80px] transform rotate-3 scale-110" />
