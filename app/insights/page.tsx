...
export default function InsightsPage() {
  return (
    ...
    >
      ...
      <section className="relative pt-48 pb-32 overflow-hidden bg-gradient-to-r from-purple-600 to-indigo-600">
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center text-white">
          ...
          <p className="text-indigo-200 text-sm font-medium tracking-wide">
            Home <span className="mx-3 opacity-60">»</span> ByteSpy Insight
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          ...
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-[#1e293b]">
              What is <span className="text-[#0ea5e9]">ByteSpy?</span>
            </h2>
            <p className="text-lg text-slate-600 mb-6 leading-relaxed">
              ByteSpy gives every packaged food a simple, AI based rating from 0 to 5, so you can quickly understand exactly what you are putting in your body without decoding complex ingredient lists.
            </p>
            <p className="text-lg text-slate-600 leading-relaxed">
              Unlike flashy front-of-pack marketing claims, the ByteSpy System looks deeper—evaluating a product's actual nutritional profile, identifying hidden sugars, and exposing misleading labels. It's time to choose better.
            </p>
          </div>
          ...
          <div className="relative flex justify-center py-4">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-purple-100 rounded-full blur-3xl -z-10" />
            ...
            <div className="absolute bottom-1/4 -right-10 bg-white p-4 rounded-2xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] border border-slate-100 z-20 animate-float hidden md:block" style={{ animationDelay: '2s' }}>
               <div className="text-[#8b5cf6] font-bold text-lg mb-1">Score: 4.8/5</div>
      ...
      <section className="py-24 px-6 md:px-12 bg-gradient-to-br from-[#60a5fa] via-[#3b82f6] to-[#030f36] text-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative border-l-4 border-purple-200 ml-4 md:ml-0 md:border-none">
            {/* Desktop Center Line */}
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-[3px] bg-purple-100 -translate-x-1/2"></div>
            ...
            >
              ...
              <div className="absolute left-[-12px] md:left-1/2 transform md:-translate-x-1/2 w-6 h-6 bg-purple-500 rounded-full border-4 border-white shadow-md"></div>
              <div className="ml-8 md:ml-0 md:w-5/12 bg-white p-7 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition">
                <div className="text-xs font-bold uppercase tracking-wider text-purple-600 mb-2">Step 1</div>
            ...
            >
              ...
              <div className="absolute left-[-12px] md:left-1/2 transform md:-translate-x-1/2 w-6 h-6 bg-indigo-500 rounded-full border-4 border-white shadow-md"></div>
              <div className="ml-8 md:ml-0 md:w-5/12 bg-white p-7 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition">
                <div className="text-xs font-bold uppercase tracking-wider text-indigo-500 mb-2">Step 2</div>
            ...
            >
              ...
              <div className="absolute left-[-12px] md:left-1/2 transform md:-translate-x-1/2 w-6 h-6 bg-emerald-500 rounded-full border-4 border-white shadow-md"></div>
              <div className="ml-8 md:ml-0 md:w-5/12 bg-white p-7 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition">
